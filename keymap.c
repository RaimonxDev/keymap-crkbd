...
//  .-----------------------------------------------------.                    .-----------------------------------------------------.
    LA_DEGREE, LA_EXLM, LA_UP, LA_HASH, LA_DOLLAR, LA_PERC,                     LA_AMPR, LA_PIPE, LA_SLASH,  LA_ASTR, LA_GRAVE, LA_BSPC,
//  |--------+--------+--------+--------+--------+--------|     /* _SYMB */    |--------+--------+--------+--------+--------+--------|
    XXXXXXX, LA_LEFT, LA_DOWN, LA_RIGHT , XXXXXXX , XXXXXXX,                    LA_LCBRC, LA_RCBRC, LA_BSLS, LA_COMM, LA_DOT, XXXXXXX,
//  |--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  LA_PSCR,                      LA_LSBRC, LA_RSBRC, XXXXXXX, LA_NEG, LA_TILDE, XXXXXXX,
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
